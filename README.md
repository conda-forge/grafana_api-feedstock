About grafana_api-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/grafana_api-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13748&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/grafana_api-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `grafana_api` can be installed with `conda`:
...
```
mamba install grafana_api
```

It is possible to list all of the versions of `grafana_api` available on your platform with `conda`:
...
```
mamba search grafana_api --channel conda-forge
```
...
mamba repoquery search grafana_api --channel conda-forge

# List packages depending on `grafana_api`:
mamba repoquery whoneeds grafana_api --channel conda-forge

# List dependencies of `grafana_api`:
mamba repoquery depends grafana_api --channel conda-forge
```
